          ...
          {classData.map((classItem, index) => (
            ...
            >
              ...
              <div className="text-right">
                <button
                  className={`px-4 py-2 text-sm rounded-lg transition duration-200 ease-in-out ${
                    classItem.buttonActive
                      ? "bg-[#344CC6] text-white hover:bg-[#2a3eab]"
                      : "bg-gray-200 text-gray-400 cursor-not-allowed"
                  }`}
                  disabled={!classItem.buttonActive}
                >
                  Join Now
                </button>
              </div>
